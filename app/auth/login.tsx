...
export default function LoginScreen() {
  ...
  return (
    <View style={{ flex: 1, width: '100%', minHeight: Platform.OS === 'web' ? ('100vh' as any) : undefined }}>
      <LinearGradient
        colors={isDarkMode ? ['#0F172A', '#1E293B', '#0F172A'] : ['#0D2464', '#1A3DA8', '#1E4FC7']}
        start={{ x: 0.2, y: 0 }}
        end={{ x: 0.8, y: 1 }}
        ...
        <SafeAreaView style={styles.safeArea} edges={['top']}>
          ...
          >
            ...
            <View style={[styles.card, { backgroundColor: themeColors.card }]}>
              ...
              <Text style={[styles.cardSub, { color: themeColors.subtext }]}>Sign in to access Government Schemes</Text>
              ...
              <View style={styles.form}>
                <AppInput
                  ...
                  icon={<Mail size={20} color={themeColors.subtext} />}
                  disabled={isLoading}
                />
                ...
                <AppInput
                  ...
                  icon={<Lock size={20} color={themeColors.subtext} />}
                  disabled={isLoading}
                />
                ...
                <TouchableOpacity
                  ...
                  disabled={isLoading}
                >
                  <Text style={[styles.forgotText, { color: Colors.primary.blue }]}>Forgot Password?</Text>
                </TouchableOpacity>

                {/* Register link */}
                <View style={styles.registerRow}>
                  <Text style={[styles.registerRowText, { color: themeColors.subtext }]}>Don't have an account? </Text>
                  <TouchableOpacity
              ...
              <View style={styles.footer}>
                <ShieldCheck size={14} color={themeColors.subtext} />
                <Text style={[styles.footerText, { color: themeColors.subtext }]}>Secure  •  Private  •  Reliable</Text>
              </View>
            </View>
          </ScrollView>
        </SafeAreaView>
